...
#+author: SeungheonOh
#+PROPERTY: header-args :tangle configuration.el :results none
...
* Evil - Moved to Vanilla Bindings!
:PROPERTIES:
...
#+end_src
* Packages
Category for packages that does not have significant configurations
** Company
#+begin_src elisp
...
#+end_src
** Corfu - Alternative to Company
:PROPERTIES:
:header-args: tangle: no
:END:
Doesn't work neatly with LSP
Don't know how to get auto tigger work
#+begin_src elisp
